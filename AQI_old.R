...
# Ozone data (8-hr)--------------------------------------------------------------------
dir_O3 <- "Z:/_SHARED_FOLDERS/Air Quality/Phase 1/Pathflow of Phase I_DG/dawit Data/daily data/8hour_O3"
EAD_O3_2013 <- read.csv(paste0(dir_O3, "/","database_EAD_2013_O3_8hour.csv"))
EAD_O3_2014 <- read.csv(paste0(dir_O3, "/","database_EAD_2014_O3_8hour.csv"))
EAD_O3_2015 <- read.csv(paste0(dir_O3, "/","database_EAD_2015_O3_8hour.csv"))
EAD_O3_2016 <- read.csv(paste0(dir_O3, "/","database_EAD_2016_O3_8hour.csv"))

DM_O3_2013 <- read.csv(paste0(dir_O3, "/","database_DM_2013_O3_8hour.csv"))
DM_O3_2014 <- read.csv(paste0(dir_O3, "/","database_DM_2014_O3_8hour.csv"))
DM_O3_2015 <- read.csv(paste0(dir_O3, "/","database_DM_2015_O3_8hour.csv"))
DM_O3_2016 <- read.csv(paste0(dir_O3, "/","database_DM_2016_O3_8hour.csv"))

NCMS_O3_2013 <- read.csv(paste0(dir_O3, "/","database_NCMS_2013_O3_8hour.csv"))
NCMS_O3_2014 <- read.csv(paste0(dir_O3, "/","database_NCMS_2014_O3_8hour.csv"))
NCMS_O3_2015 <- read.csv(paste0(dir_O3, "/","database_NCMS_2015_O3_8hour.csv"))
NCMS_O3_2016 <- read.csv(paste0(dir_O3, "/","database_NCMS_2016_O3_8hour.csv"))
...
UAE_O3$Value <- UAE_O3$Value /1.96 
...
#   filter(Pollutant == c("O3", "CO", "SO2", "NO2", "PM2.5", "PM10"))
...
names(UAE_O3)[names(UAE_O3) == 'Value'] <- 'O3_8hr'
names(UAE_O3)[names(UAE_O3) == 'Pollutant'] <- 'Pollutant_O3'
UAE_O3$Site_Type <- as.character(UAE_O3$Site_Type)
str(UAE_O3)
...
# CO data (8-hr)--------------------------------------------------------------------
dir_CO <- "Z:/_SHARED_FOLDERS/Air Quality/Phase 1/Pathflow of Phase I_DG/dawit Data/daily data/8hour_CO"
EAD_CO_2013 <- read.csv(paste0(dir_CO, "/","database_EAD_2013_CO_8hour.csv"))
EAD_CO_2014 <- read.csv(paste0(dir_CO, "/","database_EAD_2014_CO_8hour.csv"))
EAD_CO_2015 <- read.csv(paste0(dir_CO, "/","database_EAD_2015_CO_8hour.csv"))
EAD_CO_2016 <- read.csv(paste0(dir_CO, "/","database_EAD_2016_CO_8hour.csv"))

DM_CO_2013 <- read.csv(paste0(dir_CO, "/","database_DM_2013_CO_8hour.csv"))
DM_CO_2014 <- read.csv(paste0(dir_CO, "/","database_DM_2014_CO_8hour.csv"))
DM_CO_2015 <- read.csv(paste0(dir_CO, "/","database_DM_2015_CO_8hour.csv"))
DM_CO_2016 <- read.csv(paste0(dir_CO, "/","database_DM_2016_CO_8hour.csv"))

NCMS_CO_2013 <- read.csv(paste0(dir_CO, "/","database_NCMS_2013_CO_8hour.csv"))
NCMS_CO_2014 <- read.csv(paste0(dir_CO, "/","database_NCMS_2014_CO_8hour.csv"))
NCMS_CO_2015 <- read.csv(paste0(dir_CO, "/","database_NCMS_2015_CO_8hour.csv"))
NCMS_CO_2016 <- read.csv(paste0(dir_CO, "/","database_NCMS_2016_CO_8hour.csv"))
...
UAE_CO$Value <- UAE_CO$Value /1.15 
...
names(UAE_CO)[names(UAE_CO) == 'Value'] <- 'CO_8hr'
names(UAE_CO)[names(UAE_CO) == 'Pollutant'] <- 'Pollutant_CO'
UAE_CO$Site_Type <- as.character(UAE_CO$Site_Type)
str(UAE_CO)
...
######################## join O3 and CO #########
AAA <- UAE_O3 %>%
  merge(UAE_CO, by = c("Date", "Hour", "Site", "Latitude", "Longitude", "Site_Type"), 
        all=TRUE)
...
######################## join O3, CO, SO2 #######
BBB <- AAA %>%
  merge(UAE_SO2, c("Date", "Hour", "Site", "Latitude", "Longitude", "Site_Type"),
            all=TRUE)

CCC <-BBB %>%
  merge(UAE_NO2, c("Date","Hour",  "Site", "Latitude", "Longitude", "Site_Type"),
            all=TRUE)

########################

AQ_data <- CCC %>%
  merge(UAE_PM25, c("Date", "Site", "Latitude", "Longitude", "Site_Type"),
        all=TRUE)

AQ_data <- AQ_data %>%
  merge(UAE_PM10, c("Date", "Site", "Latitude", "Longitude", "Site_Type"),
            all=TRUE)

str(AQ_data)

# write_csv(AQ_data, "D:/AQI/AQ_data_all.csv")
